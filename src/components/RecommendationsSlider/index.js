...
const RecommendationsSlider = () => {
    ...
    const getTrendingMovies = async () => {
        ...
        const trendingMoviesUrl = `https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=fae62ec587f8bc50f34e46b6d33b41e2&language=en-US&page=1&include_adult=false`
    ...
    const renderTrending = () => {
        ...
        return <div className="slick-container">
            <h1 className="home-slick-heading"><BsFire className="home-slider-heading-icon"/>Recommended</h1>
            <Slider {...settings}>
