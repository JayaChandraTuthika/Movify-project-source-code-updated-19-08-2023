...
const TVshowDetails = (props) => {
  ...
  useEffect(() => {
    async function getMovieDetails() {
      ...
      const getMovieDetailsApiUrl = `https://jayauthenticationserver.onrender.com/tvshows/${id}`;
    ...
    return (
      ...
      >
        ...
        <div className="details-inner-card-1">
          ...
          <p className="md-story-overview">
            <span className="md-category-sub-heading">Seasons:</span> {seasons}
            <span className="md-category-sub-heading-2">Episodes:</span>{" "}
            {episodes}
          </p>
        </div>
      </div>
