...
const UserSettings = () => {
  ...
  const onSaveSettings = async () => {
    ...
    const response = await fetch(
      "https://jayauthenticationserver.onrender.com/update-profile",
      options
    );
    const data = await response.json();
    console.log(data);
      ...
      <div className="profile-container">
        <div className="detail-item-1">
          ...
          <div className="details-text">
            <p className="details-name">USERNAME</p>
            <div className="input-edit-container">
              {editting ? (
                <input
                  type="text"
                  className="detail-item-feild-input"
                  value={usernameInput}
        ...
        <div className="detail-item-1">
          ...
          <div className="details-text">
            <p className="details-name">PASSWORD</p>
            <div className="input-edit-container">
              {editting ? (
                <input
                  type="password"
                ...
                <p className="detail-item-feild-text">{"*********"}</p>
              )}
            </div>
          </div>
        </div>
        <div className="detail-item-1">
          ...
          <div className="details-text">
            <p className="details-name">EMAIL</p>
            <div className="input-edit-container">
        ...
        {editting ? (
          <>
            <button
              type="button"
              className="save-profile-details-btn"
            ...
            <button
              type="button"
              className="cancel-edit-profile-details-btn"
